...
public class BuyServlet extends HttpServlet {
    static final Logger logger = LogManager.getLogger(BuyServlet.class);
    ...
    public void doPost(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
            try{
                ...
                ticketsDAO.insertBoughtTicket(Long.parseLong(req.getParameter("id")),tempt.getId(),type,
                        Integer.parseInt(req.getParameter("child")), Integer.parseInt(req.getParameter("adult")),shipDAO,stationDAO,path);
