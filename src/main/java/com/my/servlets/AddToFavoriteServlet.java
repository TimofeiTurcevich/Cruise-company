...
@WebServlet("/user/addToFavorite")
public class AddToFavoriteServlet extends HttpServlet {
    static final Logger logger = LogManager.getLogger(AddToFavoriteServlet.class);
    ...
    public void doGet(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
            try{
                logger.info("AddToFavorite#DoGet");
                ...
                ticketsDAO.insertToFavorite(Long.parseLong(req.getParameter("id")),tempt.getId());
