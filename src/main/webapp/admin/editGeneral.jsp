...
<html lang="en">
  ...
  <body>
    <div class="login-box">
        ...
        <form action="changeGeneralDB?id=${param.id}" method="post">
            <div class="picklist">
                <nav>
                    <input id="shipId" type="number" name="shipId" style="display:none;" value="">
                    <label for="touch"><span id="picked"><fmt:message key="label.chooseShip"/></span></label>
                    <input type="checkbox" id="touch">
                    <div class="test2">
                        <ul class="slide">
                            <li><a id="1" onclick="pick(this,this.innerHTML)">
            ...
            <div class="user">
                <input type="number" name="standardPrice" min="1" required="">
                <label>
