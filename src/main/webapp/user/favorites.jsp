...
<html lang="en">
    ...
    <body>
        ...
        <div class="new-cruise-bar">
            <c:if test="${favoriteTickets.size()>0}">
                <c:forEach var="i" begin="${(param.page-1)*3}"
                           end="${favoriteTickets.size()<(param.page)*3?favoriteTickets.size()-1:(param.page-1)*3+2}"
                           varStatus="status1">
                    <div class="cruise">

                        <img src="../Ship_Pictures/ship_${favoriteTickets.get(i).getShip().getId()}/${favoriteTickets.get(i).getShip().getPicture().getName()}"
                        ...
                        <div class="test">
                            ...
                            <div class="text">
                                <c:forEach var="station" items="${favoriteTickets.get(i).getVoyageStations()}"
                                           varStatus="status">
                        ...
                        <div class="test">
                            ...
                            <div class="text">
                                ...
                                :
                                <c:out value="${favoriteTickets.get(i).getShip().getName()}"/>
                                <br/><br/>
                                <fmt:message key="label.departureDate"/>
                                :
                                <c:out value="${favoriteTickets.get(i).getVoyageStations().get(0).getDepartureDate().toString().replaceAll(':00.0','')}"/>
                                <br/><br/>
                                <fmt:message key="label.arrivalDate"/>
                                :
                                <c:out value="${favoriteTickets.get(i).getVoyageStations().get(favoriteTickets.get(i).getVoyageStations().size()-1).getArrivalDate().toString().replaceAll(':00.0','')}"/>
                                <br/>
                            </div>
                        </div>
                        <div class="vertical-line">
                        ...
                        <div class="more-info">
                            <c:if test="${favoriteTickets.get(i).isSale()}">
                                <div class="sale-price">
                                    ${favoriteTickets.get(i).getStandardPrice()}$ - ${favoriteTickets.get(i).getLuxPrice()}$
                                </div>
                                <div class="price">
                                    ${favoriteTickets.get(i).getSaleStandardPrice()}$ -
                                    ${favoriteTickets.get(i).getSaleLuxPrice()}$
                                </div>
                            </c:if>
                            <c:if test="${(favoriteTickets.get(i).isSale()==null) or (!favoriteTickets.get(i).isSale())}">
                                <div class="price">
                                    ${favoriteTickets.get(i).getStandardPrice()}$ - ${favoriteTickets.get(i).getLuxPrice()}$
                                </div>
                            </c:if>
                            <a href="cruise?id=${favoriteTickets.get(i).getId()}">
            ...
            <c:if test="${favoriteTickets.size()<1}">
                <div class="no-info">
        ...
        <c:if test="${favoriteTickets.size()>0}">
            <div class="pagination">
                <fmt:parseNumber var="intValue" integerOnly="true" type="number" value="${favoriteTickets.size()/3+0.9}"/>
                <div class="some">
                    <div class="pagination:container">
                        <c:if test="${param.page!=1}">
                            <a href="favorites?page=${param.page-1}">
                        ...
                        <c:if test="${intValue>7 and param.page+2<intValue}">
                            ...
                            <a href="favorites?page=${intValue}">
                                <div class="pagination:number">
                                    ${intValue}
                                </div>
                            </a>
