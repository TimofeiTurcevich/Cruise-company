...
<html lang="en">
    <head>
        <link rel="stylesheet" href="profileChangePass.css">
        <meta charset="utf-8">
        <script src="profileChangePass.js" charset="utf-8"></script>
        <title></title>
    </head>
    <body>
        <div class="menu-bar">
        ...
        <div class="profile-details">
            <div class="form">
                <form name="myForm" action="changePass" method="post" onsubmit="return validateForm()">
                    <div class="user">
